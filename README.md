...
- [Create React App with scoped CSS](#create-react-app-with-scoped-css)
...
## Create React App with scoped CSS

Using Facebook's create-react-app, we can add an additional feature to scope the css. `npx create-react-app MY_PROJECT_NAME --scripts-version react-scripts-cssmodules`. After building project, change all css files (except for index.css - that will be the global styles file) to name.modules.css
...
```
NOTE: Create-React-App version 2 should have scoped css modules built in.